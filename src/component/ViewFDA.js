      ...
      >
        <Form onFinish={handleModalSubmit} layout="vertical">
          ...
          <Form.Item
            ...
            name="link_evidence"
            rules={[
              { required: true, message: "Vui lòng nhập link_evidence!" },
            ]}
          ...
          <Form.Item
            ...
            rules={[
              { required: true, message: "Vui lòng nhập text evidence vn!" },
            ]}
      ...
      >
        <Form onFinish={handleModal3Submit} layout="vertical">
          ...
          <Form.Item
            ...
            name="link_evidence"
            rules={[
              { required: true, message: "Vui lòng nhập link evidence!" },
            ]}
            initialValue=""
          >
            <Input />
          ...
          <Form.Item
            ...
            name="text_evidence_us"
            rules={[
              { required: true, message: "Vui lòng nhập text evidence us!" },
            ]}
            initialValue=""
          >
            <Input />
